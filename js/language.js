const translations = {
  ua: {
    ...
    heroTitle: 'Ваш салон',
    heroText: 'Записатися на візит вже зараз!',
  ...
  pl: {
    ...
    heroText: 'Umów się na wizytę już teraz!',
