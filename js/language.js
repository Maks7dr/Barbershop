const translations = {
  ua: {
    ...
    heroTitle: 'Стильні стрижки',
    heroText: 'Записуйтесь на стрижку вже зараз!',
    heroTel: 'Записатися на стрижку',
  ...
  pl: {
    ...
    heroTitle: 'Stylowe fryzury',
    heroText: 'Zapisz się na fryzurę już teraz!',
    heroTel: 'Zapisz się na strzyżenie',
